...
public class Current {
    ...
    public Current(int last_updated_epoch, String last_updated, float temp_c, float temp_f, int is_day, Condition condition, float wind_mph, float wind_kph, float wind_degree, String wind_dir, float pressure_mb, float pressure_in, float precip_mm, float precip_in, int humidity, int cloud, float feelslike_c, float feelslike_f, float vis_km, float vis_miles, float uv, float gust_mph, float gust_kph) {
